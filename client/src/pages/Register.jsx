        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="glass-card w-full max-w-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input name="email" type="email" autoComplete="email" autoComplete="email" value={form.email} onChange={handleChange} className="input-field" required />
            </div>
            <div>
              <label className="form-label">Password</label>
              <div className="relative">
                <input 
                  name="password" autoComplete="new-password" autoComplete="new-password" 
